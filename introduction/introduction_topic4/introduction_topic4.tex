...
% Introduction - Topic 4 - Calibration
%
...
\newcommand{\topictitle}{Calibration } 
...
\begin{itemize}
	\item Static Calibration \vspc% Section 1
	\item Dynamic Calibration\vspc% Section 2
	\item The Calibration Curve \vspc%Section 3
	\item Example \vspc%Section 4
\end{itemize}
