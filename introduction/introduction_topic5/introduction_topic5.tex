...
% Introduction - Topic 5 - Errors in Measurements
%
...
\newcommand{\topictitle}{Errors in Measurements } 
...
\begin{itemize}
	\item The True Value \vspc% Section 1
	\item Accuracy and Error\vspc% Section 2
	\item Error and Uncertainty \vspc%Section 3
	\item Types of Errors \vspc%Section 4
\end{itemize}
