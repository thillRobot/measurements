...
% Introduction - Topic 1 - Measurement System Components
%
...
\newcommand{\topictitle}{General Measurement System} % first line of title (used by beamer)
...
\includegraphics[scale=0.25]{sensor_stage.png}\includegraphics[scale=0.25]{sensor_transducer_stage}\\
...
What is the the definition of signal? \vspc
...
\includegraphics[scale=0.3]{bulb_thermometer.png} \hspace{10mm}\includegraphics[scale=0.4]{thermocouple.jpg}
...
\small
3D printers (FDM) use PLA, ABS, PETG and other plastics which absorb mositure from the air over time causing adverse affects on part quality. This is particularly a problem in humid climates such the southeastern USA.
\end{multicols}
...
\small
\vspace{10mm}Fortunatley the {\it water-logged} plastic can be dyhdrated for further use.\vspcc
Inpsect the DIY filament dryer shown and Identify each of the following mesurement stages.
