...
\begin{itemize}
\item These lecture notes can be found on ilearn under {\bf Content > Lecture Modules}.
\item The material will be organized in 10 to 15 min lectures. You are encouraged to ask questions.
\item Lectures and most discussions will be recorded. You can watch them anytime. \vspace{3mm}\\
