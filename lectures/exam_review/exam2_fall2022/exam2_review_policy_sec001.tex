...
% Exam 2 - Review and Policy - Fall 20212
...
\usepackage{/home/tntech.edu/thill/courses/measurements/lectures/exam_review/exam_review}
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Date: Wednesday 11/14/2021
		\item {\bf Start Time}: 11:00AM {\bf Stop Time}: 1:50PM.
		\item Location: BRWN237. 
		 
		%\item Materials will be accessible in class approximately 5 minutes before exam begins (12:55PM).
		\item All exams must be turned no later than 5 minutes after exam ends (11:55PM). \vspace{1mm}\\
