...
\begin{itemize}	
\item Include an informal reference and write a brief paragraph describing a measurement system of your choice. If the system is known from personal experience a description of this can be used in place of a reference.
