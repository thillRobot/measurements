...
\newcommand{\sectiontitleIII}{Example 1: Distance and Rangers}
\newcommand{\sectiontitleIV}{Example 2: Motion and Orientation}
...
\frametitle{\sectiontitleII}
 See Module: {\it Dimensional Measurement Tools
