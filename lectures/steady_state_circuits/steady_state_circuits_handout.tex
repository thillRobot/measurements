...
%	\frame{\titlepage \center\begin{framed}\Large \textbf{Module \MNUM - \moduletitle}\end{framed} \vspace{5mm}}
  ...
  \begin{frame}
      \begin{framed}\Large \textbf{Module \MNUM - \moduletitle}\end{framed} \vspace{5mm}
  \end{frame}
	...
	\section{\sectionItitle}\label{sectionI}
		...
		\subsection{\sectionIsubsectionIItitle}\label{sectionIsubsectionII}
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					\begin{multicols}{2}
					\item {\BL \ublank} - the physical property of matter that causes it to experience a force when placed in an electromagnetic field.
					
					\includegraphics[scale=.5]{images/charges_plus_minus.png}
					\end{multicols}
					
					\item {\PR \ublank} - the difference in electric potential between two points ... can be caused by electric charge, by electric current through a magnetic field, by time-varying magnetic fields, or some combination of these three.
					
					\item {\RD \ublank} - the rate of flow of electric charge past a point or region. An electric current is said to exist when there is a net flow of electric charge through a region.
			...
			\begin{frame}
				...
				\begin{itemize}
					...
					\item {\BL \ublank} - a measure of a components opposition to the flow of electric current. The inverse quantity is electrical conductance, and is the ease with which an electric current passes.  
							
					\item {\PR \ublank} - the ratio of the change in electric charge of a system to the corresponding change in its electric potential (voltage).
					
					\item {\RD \ublank} - the tendency of an electrical conductor to oppose a change in the electric current flowing through it. The flow of electric current creates a magnetic field around the conductor. The field strength depends on the magnitude of the current, and follows any changes in current.
		...
		\subsection{\sectionIsubsectionIVtitle}\label{sectionIsubsectionIV}	
			...
			\begin{frame}
				...
				{\bfseries \ublank } - The numbers of poles refers to the number of independent conductors or circuits in a switch that are controlled by the same toggle or input.
				
				{\bfseries \ublank} - The numbers of throws refers to the number of output terminals of a switch per pole. \vspace{5mm}\\
	...
	\section{\sectionIItitle}\label{sectionII}
		...
		\subsection{\sectionIIsubsectionIIItitle}\label{sectionIIsubsectionIII}
			...
			\begin{frame}
				...
				\begin{multicols}{2}
					{\bfseries Kichhoff's Voltage Law (KVL)} - The sum of the voltages around a loop (aka mesh) equals zero.\\ $ \sum\limits_{k=1}^{n} v_k = 0 $ \\
					\includegraphics[scale=.20]{images/Kirchhoffs_voltage_law.png} 

					{\bfseries Kichhoff's Current  Law (KCL)} - The sum of the current flowing in and out of  node (aka junction) equals zero. \\ $ \sum\limits_{k=1}^{n} i_k = 0 $ \vspace{2mm}\\
	...
	\section{\sectionIIItitle}\label{sectionIII}
		...
		\subsection{\sectionIIIsubsectionIItitle}\label{sectionIIIsubsectionII}	
			...
			\begin{frame}
				...
				{\bfseries Fluid Flow - Hydraulic Analogy} \vspc
	
				Traditionally engineers have used an analogy relating the movement of electrons to the flow of water through a pipe (\href{https://en.wikipedia.org/wiki/Hydraulic_analogy}{\BL hydraulic analogy}) known as {\itshape drain-pipe theory}. \vspace{5mm}
				
				This may provide a sense of intuition {\itshape however} this comparison is not accurate do to the non-Newtonian nature of electricity and magnetism (\href{https://www.slideshare.net/PDiCEOThaneHeins3240/georgia-state-university-hyperphysics-how-newtonian-mechanics-is-incorrectly-being-applied-to-explain-the-laws-of-electricity-and-magnetism}{\GR more on this}). It can  be used to visualize some basic circuits principles, but it should not be used for analysis of complex electrical systems. 
		...
		\subsection{\sectionIIIsubsectionIItitle}\label{sectionIIIsubsectionIII}
			...
			\begin{frame}
				...
				LEDs or Light Emitting Diodes are used more and more everyday and traditional {\itshape incandescent} lights are used rarely in new deigns.\\
