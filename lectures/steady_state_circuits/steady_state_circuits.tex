	...
	\section{\sectionItitle}\label{sectionI}
		...
		\subsection{\sectionIsubsectionIVtitle}\label{sectionIsubsectionIV}	
			...
			\begin{frame}
				...
				{\bfseries Poles } - The numbers of poles refers to the number of independent conductors or circuits in a switch that are controlled by the same toggle or input.
				
				{\bfseries Throws} - The numbers of throws refers to the number of output terminals of a switch per pole. \vspace{5mm}\\
