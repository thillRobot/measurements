...
\newcommand{\topictitle}{Prototype Circuits} 

\newcommand{\sectiontitleI}{Circuits for Mechanical Engineers}
\newcommand{\sectiontitleII}{Using a Solderless Breadboard}
\newcommand{\sectiontitleIII}{Using a Desktop Power Supply}
...
% Section II - Frame I:	
	...
	\includegraphics[scale=.125]{breadboard_large.jpg} 	
	\includegraphics[scale=.65]{breadboard_wplugs.png} 
	%\includegraphics[scale=.08]{breadboard_small.jpg} 
	...
	\frametitle{\sectiontitleII}
	  ...
	  \includegraphics[scale=.080]{breadboard_template.png} 
	...
	\frametitle{\sectiontitleII}
	  ...
	  \includegraphics[scale=.20]{breadboard_wcircuit.jpg} 
	...
	\frametitle{\sectiontitleII}
	  ...
	  \includegraphics[scale=.1]{breadboard_fan_hbridge_cropped.jpg} 
	...
	\frametitle{\sectiontitleII}
	  ...
	  \includegraphics[scale=.05]{breadboard_arduino_rpi_cropped.jpg} \includegraphics[scale=.035]{breadboard_arduino_serial.jpg}
...
\hspace{5mm} \includegraphics[scale=.17]{topward.jpg}
...
\includegraphics[scale=.050]{breadboard_template.png} \hspace{10mm}\includegraphics[scale=.050]{breadboard_template.png} 
