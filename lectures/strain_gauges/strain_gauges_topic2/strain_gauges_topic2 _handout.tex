...
The resistive strain gauge, aka \hspcu\hspcu, is bonded to the surface so that is deforms with the specimen. The change in length of the bonded gauge causes a change in resistance which is used as a \hspcu\hspcu. \vspccc
...
The \hspcu\hspcu is typically used instead of the physical parameters. \vspace{10mm}\\
...
A \hspcu\hspcu converts the sensed information into a  \hspcu\hspcu \hspcu\hspcu. The signal might be mechanical, electrical, optical, or may take any other form that can be meaningfully recorded.
