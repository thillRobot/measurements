...
This may provided a sense of intuition this comparison is not accurate do to the non-Newtonian nature of electricty and magenetism (\href{https://www.slideshare.net/PDiCEOThaneHeins3240/georgia-state-university-hyperphysics-how-newtonian-mechanics-is-incorrectly-being-applied-to-explain-the-laws-of-electricity-and-magnetism}{\G more on this}). It can  be used to visualize some basic circuits principles, but it should not be used for analysis of complex electrical systems. 
...
Regardless, engineering is an integrated discipine and very few products or designs are isolated so to a single field. \vspc

Further the need for measurements in mechanical systems drives the need for a mechanical engineer to have a solid foundation in basic ciruits theory. \vspc
