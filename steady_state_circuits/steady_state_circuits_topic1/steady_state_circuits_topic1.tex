...
\newcommand{\sectiontitleIV}{Circuits in Engineering}
...
\includegraphics[scale=.6]{node_symbol.png} \hspace{15mm}
\includegraphics[scale=.6]{jump_symbol.png} \hspace{15mm}
\includegraphics[scale=.6]{switch_symbol.png} \hspace{15mm}
...
This may provided a sense of intuition this comparison is not accurate do to the non-Newtonian nature of electricity and magnetism (\href{https://www.slideshare.net/PDiCEOThaneHeins3240/georgia-state-university-hyperphysics-how-newtonian-mechanics-is-incorrectly-being-applied-to-explain-the-laws-of-electricity-and-magnetism}{\G more on this}). It can  be used to visualize some basic circuits principles, but it should not be used for analysis of complex electrical systems. 
...
{\bf Circuits in Mechanical Engineering} \vspc

How much does a mechanical engineer need to know about electricity and magnetism? This is good question, and obviously it varies based on your particular area of mechanical engineering. \vspc

Regardless, engineering is an integrated discipline and very few products or designs are isolated so to a single field. \vspc

Further the need for measurements in mechanical systems drives the need for a mechanical engineer to have a solid foundation in basic circuits theory. \vspc
