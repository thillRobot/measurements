...
Consider the simple circuit shown for measuring light intensity. 
\begin{multicols}{2}
\includegraphics[scale=.2]{ldr_circuit.png}
\begin{enumerate}
\item Find the current in the loop. 
\item Find the voltage drop across the LDR.
\item Find the voltage drop across the $10k\Omega$ resistor.
\item Find the power dissipated in the resistor and the total energy lost to heat over 10 seconds. 
\end{enumerate}
\end{multicols}
}
