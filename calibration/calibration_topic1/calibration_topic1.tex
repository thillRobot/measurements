...
{\tiny Text: \underline{Theory and Design of Mechanical Measurments, 5th Edition}}
}

\frame{
\frametitle{\sectiontitleII}

A {\G dimension} defines a physical variable that is used to describe some aspect of a physical system. A
...
The {\B base units} relate directly to a standard (historically).\vspc
...
{\B Working} standard&---&Used to calibrate local instruments\\ \hline 
\end{tabular}
