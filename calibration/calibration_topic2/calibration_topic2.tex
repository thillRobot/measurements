...
A {\B calibration} applies a known {\PN input value} to a measurement system for the purpose of observing the
system {\PR output value}. It establishes the relationship between the input and output values. The known
value used for the {\B calibration} is called the {\OR standard}. \vspc
...
{\tiny Image: \underline{Theory and Design of Mechanical Measurments, 5th Edition}, }
}
...
\textbf{Question:} How many parameters or variables are neededto describe the curve?
