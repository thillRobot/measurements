...
\newcommand{\topictitle}{The Bridge Factor} 
...
\scalebox{1}{$\frac{\delta E_{out}}{E_{in}}=\frac{\delta R/R}{4+2\left(\delta R/R\right)}\approx \frac{\delta R/R}{4}$} \hspc or \hspc \scalebox{1}{$\frac{\delta E_{out}}{E_{in}}=\frac{GF\epsilon}{4+2GF\epsilon}\approx \frac{\delta GF\epsilon}{4}$} \vspcc
...
\scalebox{1}{$\frac{\delta E_{out}}{E_{in}}=\frac{GF}{4}\left(\epsilon_1-\epsilon_2+\epsilon_4-\epsilon_3\right)=\kappa\frac{GF}{4}$}\vspcc

The constant $\kappa$ is known as the bridge factor.
