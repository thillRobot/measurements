...
The RC circuit is a first order system. The response to a step input $v_s$ is exponential which is decscribed a single parameter the time constant $\tau$. 
\vspc

\begin{multicols}{2}
\includegraphics[scale=0.35]{rc_circuit.png} 	
...
\includegraphics[scale=0.5]{time_axis.png} 	
\end{multicols}
...
Consider the bulb thermometer shown which can be modeled as a first order system.  If the system was intially at T$0$
