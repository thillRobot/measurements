...
The exact value of a variable is called the \hspcu. The value of the variables as indicated by a
...
\begin{framed}\scalebox{1}{$\hspace{10mm}{\R error} =$}\end{framed}
...
\begin{framed}\scalebox{1}{$\hspace{20mm} {\PR accuracy} = $}\end{framed}

An estimate of error based using this value is sometimes referred to as \hspcu. \vspc
