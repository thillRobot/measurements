...
% Topic 5 - Errors and Uncertainty
%
...
\begin{itemize}
	...
	\item Random and Systematic Errors \vspc%Section 1
	\item Dart Board Example \vspc%Section 2
	\item Types of Errors  \vspc% Section 3
	\item Sample Uncertainty Data \vspc % Section 4
...
% Section 4
\section{Sample Uncertainty Data}

\frame{
\frametitle{Sample Uncertainty Data}

\includegraphics[scale=.2]{sample_uncertainties.png}
