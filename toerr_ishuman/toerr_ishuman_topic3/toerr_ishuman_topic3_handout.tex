...
``\hspcu\hspcu\hspcu\hspcu\hspcu \\
provides a measure of the instrument {\PN repeatability}. Specific claims of
...
\item the same experimental \hspcu
\item the same \hspcu
\item the same measuring instrument, used under \hspcu
\item the same location
\item repetition over a short \hspcu
...
``The term\hspcu , when reported in instrument specifications, refers to the closeness of
...
\hspcu based on the results of separate repeatability tests.'' \vspace{10mm} \\
